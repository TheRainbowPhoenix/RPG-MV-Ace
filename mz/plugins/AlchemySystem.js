...
(function (AlchemySystem) {
    ...
    class Scene_Alchemy extends Scene_MenuBase {
        ...
        categoryWindowRect() {
            ...
            const ww = (EnabledGoldWindow ? Graphics.boxWidth * 0.67 - goldWindowRect.width : Graphics.boxWidth);
        ...
        selectRecipesWindowRect() {
            ...
            const ww = Math.floor(Graphics.boxWidth * 0.67 / 2);
        ...
        recipeDetailWindowRect() {
            ...
            const ww = Graphics.boxWidth * 0.67 - wx;
